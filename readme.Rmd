---
title: "MOW - REPORT"
subtitle: "Ensemble model - applying any classification algorithm to bootstrap samples from a training set with randomly selected subset of attributes."
...
train_and_test_ensemble(df, 'lr', rpart_fun, 'rpart', 'lettr')
train_and_test_ensemble(df, 'lr', naiveBayes_fun, 'naivebayes', 'lettr')
```
