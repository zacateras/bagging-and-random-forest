...
### Experiments
We will start experiments section with loading necessary external libraries announced in the proceeding sections:
...
```
It seams that our ensemble model is not better than native implementations of *randomForest* and *rpart* in terms of accuracy and F1 score.
